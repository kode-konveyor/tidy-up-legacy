...
public class WorkRequestCreateForbiddenTest extends WorkRequestTestBase {
	@Test
	public void call() {
		...
		ResponseEntity<WorkRequestResource> responseOther = workRequestController.post(OTHER_USER_IDENTIFIER,
				requestDto());
