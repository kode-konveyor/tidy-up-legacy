...
public class WorkRequestPutForbiddenTest extends WorkRequestTestBase {
	@Test
	public void call() {
		...
		ResponseEntity<WorkRequestResource> responseOther = workRequestController.put(OTHER_USER_IDENTIFIER,
