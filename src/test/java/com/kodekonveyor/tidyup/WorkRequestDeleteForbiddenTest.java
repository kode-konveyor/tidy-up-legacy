...
public class WorkRequestDeleteForbiddenTest extends WorkRequestTestBase {
	@Test
	public void call() {
		...
		ResponseEntity<?> responseOther = workRequestController.delete(OTHER_USER_IDENTIFIER,
